...
elixir((mix) => {
    mix
        ...
        .rollup('./core/assets-management/resources/assets/js/edutalk-core.js', publicPath + 'admin/js')
        .rollup('./core/assets-management/resources/assets/js/script.js', publicPath + 'admin/js')

        .rollup('./core/assets-management/resources/assets/js/Components/DataTables/DataTable.js', publicPath + 'admin/modules/datatables/Edutalk.datatable.js')
        .rollup('./core/assets-management/resources/assets/js/Components/DataTables/DataTableAjax.js', publicPath + 'admin/modules/datatables/Edutalk.datatable.ajax.js')
