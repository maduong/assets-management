...
- [angular-bootstrap-switch](https://gitlab.edutalk.vn/frapontillo/angular-bootstrap-switch)
- [angular-toggle-switch](https://gitlab.edutalk.vn/JumpLink/angular-toggle-switch)

## KnockoutJs

A Knockout binding handler is available [here](https://gitlab.edutalk.vn/pauloortins/knockout-bootstrap-switch)

## NuGet

A NuGet package is available [here](https://gitlab.edutalk.vn/blachniet/bootstrap-switch-nuget)
...
We are in the process of changing from Apache to MIT. If you contributed before February 5th, 2015, please add your vote here to accept license change: https://gitlab.edutalk.vn/nostalgiaz/bootstrap-switch/issues/347
