...
* New animation directions (see https://gitlab.edutalk.vn/fancyapps/fancyBox/issues/233#issuecomment-5512453)
...
*     - Facebook-style (https://gitlab.edutalk.vn/fancyapps/fancyBox/issues/24) and therefore uses image for background
