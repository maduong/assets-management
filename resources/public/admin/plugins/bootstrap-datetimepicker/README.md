...
This project is a fork of [bootstrap-datepicker project](https://gitlab.edutalk.vn/eternicode/bootstrap-datepicker).
...
![Datetimepicker decade year view](https://raw.gitlab.edutalk.vn/smalot/bootstrap-datetimepicker/master/screenshot/standard_decade.png)

This view allows to select the day in the selected month.

## Year view

![Datetimepicker year view](https://raw.gitlab.edutalk.vn/smalot/bootstrap-datetimepicker/master/screenshot/standard_year.png)

This view allows to select the month in the selected year.

## Month view

![Datetimepicker month view](https://raw.gitlab.edutalk.vn/smalot/bootstrap-datetimepicker/master/screenshot/standard_month.png)

This view allows to select the year in a range of 10 years.

## Day view

![Datetimepicker day view](https://raw.gitlab.edutalk.vn/smalot/bootstrap-datetimepicker/master/screenshot/standard_day.png)

This view allows to select the hour in the selected day.

## Hour view

![Datetimepicker hour view](https://raw.gitlab.edutalk.vn/smalot/bootstrap-datetimepicker/master/screenshot/standard_hour.png)
...
![Datetimepicker day view meridian](https://raw.gitlab.edutalk.vn/smalot/bootstrap-datetimepicker/master/screenshot/standard_day_meridian.png)
...
![Datetimepicker hour view meridian](https://raw.gitlab.edutalk.vn/smalot/bootstrap-datetimepicker/master/screenshot/standard_hour_meridian.png)
...
To enalbe this feature. [jQuery Mouse Wheel Plugin](https://gitlab.edutalk.vn/brandonaaron/jquery-mousewheel) must be included before using this feature. 
